  ...
  return (
    <section id='types' className='app-container py-16'>
      <div className='text-center mb-12'>
        <span className='section-subheader'>AI Tchnology</span>
        <h2 className='section-subheader'>Diffrent Types{" "}
          <span className='gradient-text'>Artificel Intelegent</span>
        </h2>
        <p className='section-description'>
          Manus isn't just a paragraph generator. It's a complete writing toolkit. Rewrite, translate, shorten, grammar check or expand your content with one click.Everything you need for writing is in one place.
        </p>
      </div>
