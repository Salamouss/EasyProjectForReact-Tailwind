...
function Navbar() {
  ...
  return (
    <nav className='bg-white/80 backdrop-blur-none shadow-sm fixed w-full z-50'>
      ...
      {/* mobile Menu */}
      {mobileMenuOpen && (
        <div className='md:hidden bg-white  shadow-lg rounded-b-lg px-2 pb-3 pt-2 space-y-1'>
          {
          links.map((link) => (
